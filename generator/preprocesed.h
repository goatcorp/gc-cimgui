...
struct ImVec2
{
    ...
    float operator[] (size_t idx) const { (void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"./../imgui/imgui.h", (unsigned)(260)), 0) ); return (&x)[idx]; }
    float& operator[] (size_t idx) { (void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"./../imgui/imgui.h", (unsigned)(261)), 0) ); return (&x)[idx]; }
};
struct ImVec4
{
    float x, y, z, w;
...
struct ImBitArray
{
    ...
    bool TestBit(int n) const { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"./../imgui/imgui_internal.h", (unsigned)(571)), 0) ); return ImBitArrayTestBit(Storage, n); }
    void SetBit(int n) { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"./../imgui/imgui_internal.h", (unsigned)(572)), 0) ); ImBitArraySetBit(Storage, n); }
    void ClearBit(int n) { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"./../imgui/imgui_internal.h", (unsigned)(573)), 0) ); ImBitArrayClearBit(Storage, n); }
    void SetBitRange(int n, int n2) { n += OFFSET; n2 += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT", L"./../imgui/imgui_internal.h", (unsigned)(574)), 0) ); ImBitArraySetBitRange(Storage, n, n2); }
    bool operator[](int n) const { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"./../imgui/imgui_internal.h", (unsigned)(575)), 0) ); return ImBitArrayTestBit(Storage, n); }
};
struct ImBitVector
{
    ...
    bool TestBit(int n) const { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"./../imgui/imgui_internal.h", (unsigned)(585)), 0) ); return ImBitArrayTestBit(Storage.Data, n); }
    void SetBit(int n) { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"./../imgui/imgui_internal.h", (unsigned)(586)), 0) ); ImBitArraySetBit(Storage.Data, n); }
    void ClearBit(int n) { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"./../imgui/imgui_internal.h", (unsigned)(587)), 0) ); ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T& operator[](int i) { T* p = Data + i; (void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"./../imgui/imgui_internal.h", (unsigned)(607)), 0) ); return *p; }
    inline const T& operator[](int i) const { const T* p = Data + i; (void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"./../imgui/imgui_internal.h", (unsigned)(608)), 0) ); return *p; }
    inline T* begin() { return Data; }
    inline const T* begin() const { return Data; }
    inline T* end() { return DataEnd; }
    inline const T* end() const { return DataEnd; }
    inline int index_from_ptr(const T* it) const { (void)( (!!(it >= Data && it < DataEnd)) || (_wassert(L"it >= Data && it < DataEnd", L"./../imgui/imgui_internal.h", (unsigned)(616)), 0) ); const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void Reserve(int n, size_t sz, int a=4) { (void)( (!!(n == CurrIdx && n < CHUNKS)) || (_wassert(L"n == CurrIdx && n < CHUNKS", L"./../imgui/imgui_internal.h", (unsigned)(632)), 0) ); CurrOff = (((CurrOff) + ((a) - 1)) & ~((a) - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int GetArenaSizeInBytes() { return CurrOff; }
    inline void SetArenaBasePtr(void* base_ptr) { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n) { (void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"./../imgui/imgui_internal.h", (unsigned)(635)), 0) ); return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n) { (void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"./../imgui/imgui_internal.h", (unsigned)(636)), 0) ); return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImPool
{
    ...
    ImPoolIdx GetIndex(const T* p) const { (void)( (!!(p >= Buf.Data && p < Buf.Data + Buf.Size)) || (_wassert(L"p >= Buf.Data && p < Buf.Data + Buf.Size", L"./../imgui/imgui_internal.h", (unsigned)(657)), 0) ); return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T* next_chunk(T* p) { size_t HDR_SZ = 4; (void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"./../imgui/imgui_internal.h", (unsigned)(692)), 0) ); p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0; (void)( (!!(p < end())) || (_wassert(L"p < end()", L"./../imgui/imgui_internal.h", (unsigned)(692)), 0) ); return p; }
    int chunk_size(const T* p) { return ((const int*)p)[-1]; }
    T* end() { return (T*)(void*)(Buf.Data + Buf.Size); }
    int offset_from_ptr(const T* p) { (void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"./../imgui/imgui_internal.h", (unsigned)(695)), 0) ); const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T* ptr_from_offset(int off) { (void)( (!!(off >= 4 && off < Buf.Size)) || (_wassert(L"off >= 4 && off < Buf.Size", L"./../imgui/imgui_internal.h", (unsigned)(696)), 0) ); return (T*)(void*)(Buf.Data + off); }
...
struct ImGuiStackTool
{
    ...
    ImGuiStackTool() { memset(this, 0, sizeof(*this)); CopyToClipboardLastTime = -3.40282347e+38F; }
};
...
struct ImGuiTabBar
{
    ...
    const char* GetTabName(const ImGuiTabItem* tab) const
    {
        ...
        (void)( (!!(tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size)) || (_wassert(L"tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size", L"./../imgui/imgui_internal.h", (unsigned)(2466)), 0) );
...
namespace ImGui
{
    ...
    inline bool IsKeyPressedMap(ImGuiKey key, bool repeat = true) { (void)( (!!(IsNamedKey(key))) || (_wassert(L"IsNamedKey(key)", L"./../imgui/imgui_internal.h", (unsigned)(2949)), 0) ); return IsKeyPressed(key, repeat); }
