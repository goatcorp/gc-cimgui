...
struct ImVec2
{
    ...
    float  operator[] (size_t idx) const    { ((void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(260)), 0)) ); return (&x)[idx]; }    
    float& operator[] (size_t idx)          { ((void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(261)), 0)) ); return (&x)[idx]; }    
};
struct ImVec4
{
    float                                                     x, y, z, w;
...
namespace ImGui
{
     ...
     ImFont*       GetFont();                                                      
     float         GetFontSize();                                                  
     ImTextureID   GetFontTexIdWhitePixel();                                       
...
struct ImVector
{
    ...
    inline T&           operator[](int i)                   { ((void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1881)), 0)) ); return Data[i]; }
    inline const T&     operator[](int i) const             { ((void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1882)), 0)) ); return Data[i]; }
    inline T*           begin()                             { return Data; }
    inline const T*     begin() const                       { return Data; }
    inline T*           end()                               { return Data + Size; }
    inline const T*     end() const                         { return Data + Size; }
    inline T&           front()                             { ((void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1888)), 0)) ); return Data[0]; }
    inline const T&     front() const                       { ((void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1889)), 0)) ); return Data[0]; }
    inline T&           back()                              { ((void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1890)), 0)) ); return Data[Size - 1]; }
    inline const T&     back() const                        { ((void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1891)), 0)) ); return Data[Size - 1]; }
    inline void         swap(ImVector<T>& rhs)              { int rhs_size = rhs.Size; rhs.Size = Size; Size = rhs_size; int rhs_cap = rhs.Capacity; rhs.Capacity = Capacity; Capacity = rhs_cap; T* rhs_data = rhs.Data; rhs.Data = Data; Data = rhs_data; }
    inline int          _grow_capacity(int sz) const        { int new_capacity = Capacity ? (Capacity + Capacity / 2) : 8; return new_capacity > sz ? new_capacity : sz; }
    inline void         resize(int new_size)                { if (new_size > Capacity) reserve(_grow_capacity(new_size)); Size = new_size; }
    inline void         resize(int new_size, const T& v)    { if (new_size > Capacity) reserve(_grow_capacity(new_size)); if (new_size > Size) for (int n = Size; n < new_size; n++) memcpy(&Data[n], &v, sizeof(v)); Size = new_size; }
    inline void         shrink(int new_size)                { ((void)( (!!(new_size <= Size)) || (_wassert(L"new_size <= Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1897)), 0)) ); Size = new_size; } 
    ...
    inline void         pop_back()                          { ((void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1903)), 0)) ); Size--; }
    inline void         push_front(const T& v)              { if (Size == 0) push_back(v); else insert(Data, v); }
    inline T*           erase(const T* it)                  { ((void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1905)), 0)) ); const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + 1, ((size_t)Size - (size_t)off - 1) * sizeof(T)); Size--; return Data + off; }
    inline T*           erase(const T* it, const T* it_last){ ((void)( (!!(it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size)) || (_wassert(L"it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1906)), 0)) ); const ptrdiff_t count = it_last - it; const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + count, ((size_t)Size - (size_t)off - (size_t)count) * sizeof(T)); Size -= (int)count; return Data + off; }
    inline T*           erase_unsorted(const T* it)         { ((void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1907)), 0)) );  const ptrdiff_t off = it - Data; if (it < Data + Size - 1) memcpy(Data + off, Data + Size - 1, sizeof(T)); Size--; return Data + off; }
    inline T*           insert(const T* it, const T& v)     { ((void)( (!!(it >= Data && it <= Data + Size)) || (_wassert(L"it >= Data && it <= Data + Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1908)), 0)) ); const ptrdiff_t off = it - Data; if (Size == Capacity) reserve(_grow_capacity(Size + 1)); if (off < (int)Size) memmove(Data + off + 1, Data + off, ((size_t)Size - (size_t)off) * sizeof(T)); memcpy(&Data[off], &v, sizeof(v)); Size++; return Data + off; }
    ...
    inline int          index_from_ptr(const T* it) const   { ((void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1914)), 0)) ); const ptrdiff_t off = it - Data; return (int)off; }
};
struct ImGuiStyle
{
    float       Alpha;                      
...
struct ImGuiTextBuffer
{
    ...
    ImGuiTextBuffer()   { }
    inline char         operator[](int i) const { ((void)( (!!(Buf.Data != ((void *)0))) || (_wassert(L"Buf.Data != ((void *)0)", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2338)), 0)) ); return Buf.Data[i]; }
...
struct ImFontAtlasCustomRect
{
    ...
    ImVec2          GlyphOffset;    
    ImFont*         Font;           
    ImFontAtlasCustomRect()         { Width = Height = 0; X = Y = 0xFFFF; Reserved = 0; TextureIndex = 0; GlyphID = 0; GlyphAdvanceX = 0.0f; GlyphOffset = ImVec2(0, 0); Font = ((void *)0); }
...
struct ImFontAtlas
{
     ...
     void              Clear();                    
     bool              Build();                    
     void              GetTexDataAsAlpha8(int texture_index, unsigned char** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel = ((void *)0));  
     void              GetTexDataAsRGBA32(int texture_index, unsigned char** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel = ((void *)0));  
    ...
    ImFontAtlasCustomRect*      GetCustomRectByIndex(int index) { ((void)( (!!(index >= 0)) || (_wassert(L"index >= 0", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2939)), 0)) ); return &CustomRects[index]; }
    ...
    ImVector<ImFontAtlasTexture>Textures;           
    int                         TexDesiredWidth;    
...
struct ImFont
{
    ImVector<ImFontGlyphHotData>IndexedHotData;     
    ImVector<float>             FrequentKerningPairs;
    float                       FontSize;           
    ...
    ImU8                        Used4kPagesMap[(0xFFFF+1)/4096/8]; 
     ...
     float             GetDistanceAdjustmentForPair(ImWchar left_c, ImWchar right_c) const;
    ...
    const char*                 GetDebugName() const                { return ConfigData ? ConfigData->Name : "<unknown>"; }
     ...
     void              AddGlyph(const ImFontConfig* src_cfg, ImWchar c, int texture_index, float x0, float y0, float x1, float y1, float u0, float v0, float u1, float v1, float advance_x);
     ...
     void              AddKerningPair(ImWchar left_c, ImWchar right_c, float distance_adjustment);
     float             GetDistanceAdjustmentForPairFromHotData(ImWchar left_c, const ImFontGlyphHotData* right_c_info) const;
};
...
struct ImGuiViewport
{
    ...
    ~ImGuiViewport()    { ((void)( (!!(PlatformUserData == ((void *)0) && RendererUserData == ((void *)0))) || (_wassert(L"PlatformUserData == ((void *)0) && RendererUserData == ((void *)0)", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(3123)), 0)) ); }
...
struct ImBitArray
{
    ...
    bool            TestBit(int n) const        { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(571)), 0)) ); return ImBitArrayTestBit(Storage, n); }
    void            SetBit(int n)               { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(572)), 0)) ); ImBitArraySetBit(Storage, n); }
    void            ClearBit(int n)             { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(573)), 0)) ); ImBitArrayClearBit(Storage, n); }
    void            SetBitRange(int n, int n2)  { n += OFFSET; n2 += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(574)), 0)) ); ImBitArraySetBitRange(Storage, n, n2); } 
    bool            operator[](int n) const     { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(575)), 0)) ); return ImBitArrayTestBit(Storage, n); }
};
struct  ImBitVector
{
    ...
    bool            TestBit(int n) const        { ((void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(585)), 0)) ); return ImBitArrayTestBit(Storage.Data, n); }
    void            SetBit(int n)               { ((void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(586)), 0)) ); ImBitArraySetBit(Storage.Data, n); }
    void            ClearBit(int n)             { ((void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(587)), 0)) ); ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T&           operator[](int i)           { T* p = Data + i; ((void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(607)), 0)) ); return *p; }
    inline const T&     operator[](int i) const     { const T* p = Data + i; ((void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(608)), 0)) ); return *p; }
    inline T*           begin()                     { return Data; }
    inline const T*     begin() const               { return Data; }
    inline T*           end()                       { return DataEnd; }
    inline const T*     end() const                 { return DataEnd; }
    inline int  index_from_ptr(const T* it) const   { ((void)( (!!(it >= Data && it < DataEnd)) || (_wassert(L"it >= Data && it < DataEnd", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(616)), 0)) ); const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void  Reserve(int n, size_t sz, int a=4) { ((void)( (!!(n == CurrIdx && n < CHUNKS)) || (_wassert(L"n == CurrIdx && n < CHUNKS", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(632)), 0)) ); CurrOff = (((CurrOff) + ((a) - 1)) & ~((a) - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int   GetArenaSizeInBytes()              { return CurrOff; }
    inline void  SetArenaBasePtr(void* base_ptr)    { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n)             { ((void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(635)), 0)) ); return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n)               { ((void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(636)), 0)) ); return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImPool
{
    ...
    ImPoolIdx   GetIndex(const T* p) const          { ((void)( (!!(p >= Buf.Data && p < Buf.Data + Buf.Size)) || (_wassert(L"p >= Buf.Data && p < Buf.Data + Buf.Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(657)), 0)) ); return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T*      next_chunk(T* p)            { size_t HDR_SZ = 4; ((void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(692)), 0)) ); p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0; ((void)( (!!(p < end())) || (_wassert(L"p < end()", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(692)), 0)) ); return p; }
    int     chunk_size(const T* p)      { return ((const int*)p)[-1]; }
    T*      end()                       { return (T*)(void*)(Buf.Data + Buf.Size); }
    int     offset_from_ptr(const T* p) { ((void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(695)), 0)) ); const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T*      ptr_from_offset(int off)    { ((void)( (!!(off >= 4 && off < Buf.Size)) || (_wassert(L"off >= 4 && off < Buf.Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(696)), 0)) ); return (T*)(void*)(Buf.Data + off); }
...
struct  ImGuiTabBar
{
    ...
    const char*         GetTabName(const ImGuiTabItem* tab) const
    {
        ...
        ((void)( (!!(tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size)) || (_wassert(L"tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(2471)), 0)) );
...
namespace ImGui
{
    ...
    inline bool             IsKeyPressedMap(ImGuiKey key, bool repeat = true)           { ((void)( (!!(IsNamedKey(key))) || (_wassert(L"IsNamedKey(key)", L"H:\\repos\\Dalamud\\lib\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(2954)), 0)) ); return IsKeyPressed(key, repeat); } 
    ...
    inline ImGuiInputTextState* GetInputTextState(ImGuiID id)   { ImGuiContext& g = *GImGui; return (g.InputTextState.ID == id) ? &g.InputTextState : ((void *)0); } 
     void Custom_StbTextMakeUndoReplace(ImGuiInputTextState* str, int where, int old_length, int new_length);
     void Custom_StbTextUndo(ImGuiInputTextState* str);
...
struct stbtt_pack_context;
 ...
 void      ImFontAtlasBuildRender8bppRectFromString(ImFontAtlas* atlas, int texture_index, int x, int y, int w, int h, const char* in_str, char in_marker_char, unsigned char in_marker_pixel_value);
 void      ImFontAtlasBuildRender32bppRectFromString(ImFontAtlas* atlas, int texture_index, int x, int y, int w, int h, const char* in_str, char in_marker_char, unsigned int in_marker_pixel_value);
 void      ImFontAtlasBuildMultiplyCalcLookupTable(unsigned char out_table[256], float in_multiply_factor, float gamma_factor);
